...
SyntaxModeGame.prototype.next_question = function () {
    ...
    //todo below is a dummy function that doesn't do anything yet
    var data = make_syntax_question(this.current_chapter, this.current_question);
    console.log("DEBUG exited make_output with data = ", data);
