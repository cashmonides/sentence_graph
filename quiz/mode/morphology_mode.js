...
// morphology mode is like kck mode

// it produces a kck sentence, picks a target language and a source language
// specifies a path for the drop downs, compares path to correct path and answer
// has the same cheat sheets
...
KCKModeGame.prototype.next_question = function () {
    ...
    // LITTLE CHANGE no source and target from weighted
    ...
    //BIG CHANGE get drops and non drops
    // keep lexeme and beginning the same as it was in kck mode
    // for middle and ending, put all possibilities
    ...
    //BIG CHANGE
    // for now keep dashes always in morphological mode
    // careful not to keep metacharacters
