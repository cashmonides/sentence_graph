...
var remove_embedded_root_span = function (string) {
    string = replace_all_substrings(string, "<span class=\"embedded_root\">", "");
    string = replace_all_substrings(string, "</span>", "");
    return string;
}


var preprocess_embedded_root_span = function (string) {
    string = replace_all_substrings(string, "<span class=\"embedded_root\">", "<");
    string = replace_all_substrings(string, "</span>", ">");
    return string;
}
...
// Just replace percet signs by slashes.
var convert_words_from_firebase_to_normal = function (words) {
    return words.map(function (x) {return x.replace(/%/g, '/')});
}