...
// This function takes a class name (as string) and returns a list of elements with that class name.
// It does this by getting an HTMLCollection of elements with the given class name,
// then using the [].slice.call trick to turn that collection into an array.
var cl = function (x) {
    return [].slice.call(document.getElementsByClassName(x));
}


var set_inner_html_of_class = function (a, b) {
    // Get the elements with the given class name.
    var divs = cl(a);
    // Set the HTML of each to the given string.
...
var set_display_of_class = function (a, b) {
    // Get the elements with the given class name.
    var divs = cl(a);
    // Set the display of each to the given display mode.
    divs.forEach(function (div) {
        div.style.display = b;
    });
}
...
var clear_inner_html_of_class = function (a) {
    // Set the inner HTML of each element with the given class to an empty string.
    set_inner_html_of_class(a, '');
    /*
    var e = cl(a);
