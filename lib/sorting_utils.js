...
var magic = function (x) {
    return x.replace(/\d+/g, function (z) {return String.fromCharCode(4096+ +z)}).split('').map(function (x) {var c; return ((c = x.charCodeAt(0)) > 4000) ? c - 4096 : (c + 100)});
}
...
var sentence_sort = function (x, y) {
    ...
    for (var i = 0; i < x_s.length; i++) {
        x_i_as_number = magic(x_s[i]);
        y_i_as_number = magic(y_s[i]);
