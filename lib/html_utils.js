...
var set_display = function (a, b) {
    console.log("GRIMES999 entering set_display");
    console.log("GRIMES999 div_name to change = ", a);
    console.log("GRIMES999 property to change to  = ", b);
    var e = el(a);
...
var set_display_of_class = function (a, b) {
    var divs = document.getElementsByClassName(a);
    if (!divs) {
        bug.log("PROBLEM no divs in set_display_of_class");
        return;
    }
    [].slice.call(divs).forEach(function (div) {
        div.style.display = b;
...
var set_font_color_of_class = function (a, b) {
    var divs = document.getElementsByClassName(a);
    if (!divs) {
        bug.log("PROBLEM no divs in set_font_color_of_class");
        return;
    }
    [].slice.call(divs).forEach(function (div) {
        // div.style.fontWeight = b;
        div.style.color = b;
    });
}

var set_case_of_class = function (a, b) {
    var divs = document.getElementsByClassName(a);
    if (!divs) {
        bug.log("PROBLEM no divs in set_font_color_of_class");
        return;
    ...
    [].slice.call(divs).forEach(function (div) {
        // div.style.fontWeight = b;
        div.style.textTransform = b;
    });
}



var set_font_weight_of_class = function (a, b) {
    var divs = document.getElementsByClassName(a);
    if (!divs) {
        bug.log("PROBLEM no divs in set_font_color_of_class");
        return;
...
var clear_inner_html_of_class = function (a) {
    ...
    if (e) {
        ...
        return;
        bug.log("PROBLEM: clear_inner_html: e does not exist")
    };
}
