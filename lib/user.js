...
User.prototype.submodule_complete = function (module_id) {
    ...
    console.log("12-30 about to enter log_submodule_stop_time");
    // this.log_submodule_stop_time(module_id, mod.progress);
    mod.progress++;
    ...
    if (rollover) {
        ...
        // todo if a user is improving, rollover should return him to profile
        // but this.quiz.advance_improve_status is undefined
        // it must be that this.quiz is an obsolete piece of data
        // so we need some way to determine what our advance/improve status is
        console.log('this =', this);
        if (this.quiz.advance_improve_status === "improving") {
