...
var getting = function (prop, f) {
    var self = this;
    return function () {
        var args = arguments;
        Persist.get(prop, function (x) {f.bind(self, x.val()).apply(this, args);})
    }
}
...
*/
User.prototype.log_sentences = getting(['history'], function (
    setence_logs, mod_id, chapter, sentence_number, status) {
