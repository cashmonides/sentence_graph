...
function (sentence_logs, sentence_finder, status, mode, callback) {
    var chapter = sentence_finder.chapter_n;
    
    var sentence_number = sentence_finder.question_n;
    console.log("sentence_logs, chapter, sentence_number, status =",
    sentence_logs, chapter, sentence_number, status);
    ...
    sentence_logs[chapter + '-' + sentence_number + ' ' + mode] = status;
