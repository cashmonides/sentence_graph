...
var isBackDebug = true; //global debug state
var back = Backlogger(isBackDebug, 'development');
...
var isBugDebug = true; //global debug state
var bug = Buglogger(isBugDebug, 'bug_logging');
