...
ProgressBar.prototype.decrement_as_countdown = function (stopping_time) {
    ...
    console.log('123456 difference = ', difference);
    ...
    // e.g. 10
    this.progress = difference * 0.0001;
    ...
    // will produce a progress width of (10/60)*100 + %
    
    var percentage = (this.progress / this.size) * 100;
