...
function post (json, callback, url, async_bool) {
	...
	console.log("DEBUG-POST ajax post initiated");
    //AJAX request
	...
	console.log('DEBUG-POST json stringified =', j);
	
	console.log("DEBUG-POST json not-stringified =", json);
	
	
	
	console.log("DEBUG-POST ajax req.send about to be performed");
...
function wrap_callback(req, success, failure){
	console.log("DEBUG-POST wrap_callback about to be performed");
	console.log("DEBUG-POST about to log req.responseText");
	console.log('DEBUG POST req.responseText = ',
			    req.responseText)
	return function(){
