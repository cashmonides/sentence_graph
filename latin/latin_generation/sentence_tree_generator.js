...
function make_kernel (level, language_enum, state) {
    ...
    var template = make_kernel_template(kernel);
...
//todo language_enum is not implemented well - bot h inflect english and inflect latin are hard-coded whereas they should be dependent on language_enum
...
function make_kernel_new (level, language_enum, state, old_lexeme_list) {
    ...
    var template = make_kernel_template(state);
