...
info from module:
use all these conjunctions
with all these allowed parameters (voice, sequence, etc.)
drop-down-path
don't use these tense-mood-voices 



what makes a good dictionary traversal?
    - tense-mood-voice are bundled together
        - fed into both morphology and translation formula




conjunction --gives a range of allowed-->  regime tense-mood-voice bundle  sequence


level gives  allowed_tense_mood_voice -----filter out morphological elements---> regime-tense-mood-voice sequence
...
latin tense-mood-voice + regime + additional info (basic/advanced, mfchapter)
CAN PRODUCE
english translation formula (e.g. was verbing)


WE AlSO NEED
person_irregularities (was/were)
english root conversion (attacked vs ate)

english-meta-grammar-talk
    (e.g. what is the tense called in english)
...
e.g. simultaneous-indicative-primary

we feed that into all available tenses
(because sometimes there's more than one option e.g. future & future perfect)
