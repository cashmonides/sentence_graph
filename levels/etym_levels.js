var etym_levels = {
    ...
    240 : {
        ...
        'VID/VIS', 'VAC', 'UNI', 'UN', 'THERM', 'TERR', 'SOL', 'SEPT', 'SCOP/SCOPE', 'QUIN/QUINT', 
        'QUART', 'QUAD/QUADR', 'PSEUD/PSEUDO', 'PHOT/PHOTO', 'MULTI', 'MICRO', 'METER/METR', 'MAGN', 
        'MACRO', 'HEX/HEXA', 'GASTR', 'DU',  'CHRON', 'CEPHAL', 'BIO', 'BI/BIN', 'AVI', 'AUD/AUDI/AUDIO', 'AMBI/AMPHI'],
        question_types: {
            'word_to_latin_root': .4,
            'word_to_english_root': .4,
            'word_to_translated_root': .4,
    ...
    250 : {
        ...
        'VID/VIS', 'VAC', 'UNI', 'UN', 'THERM', 'TERR', 'SOL', 'SEPT', 'SCOP/SCOPE', 'QUIN/QUINT', 
        'QUART', 'QUAD/QUADR', 'PSEUD/PSEUDO', 'PHOT/PHOTO', 'MULTI', 'MICRO', 'METER/METR', 'MAGN', 
        'MACRO', 'HEX/HEXA', 'HEPT/HEPTA', 'GEO', 'GASTR', 'DU',  'CHRON', 'CEPHAL', 'BIO', 'BI/BIN', 'AVI', 'AUD/AUDI/AUDIO', 'AMBI/AMPHI'],
        question_types: {
            'word_to_latin_root': .4,
            'word_to_english_root': .4,
            'word_to_translated_root': .4,
    ...
    260 : {
        ...
        'CHRON', 'CEPHAL', 'BIO', 'BI/BIN', 'AVI', 'AUD/AUDI/AUDIO', 'AMBI/AMPHI'],
        question_types: {
            'word_to_latin_root': .4,
            'word_to_english_root': .4,
            'word_to_translated_root': .4,
    ...
    290 : {
        ...
        'QUART', 'QUAD/QUADR', 'PSEUD/PSEUDO', 'PROT/PROTO', 'POLY',
        'PHOT/PHOTO', 'PENT/PENTA', 'PATER/PATR/PATRI', 'OCT/OCTA/OCTO', 
        'MULTI', 'MILLI', 'MICRO', 'METER/METR', 'MATER/MATR/MATRI', 
    ...
    300 : {
        ...
        'PHOT/PHOTO', 'PENT/PENTA', 'PATER/PATR/PATRI', 'OCT/OCTA/OCTO', 
        'MULTI', 'MILLI', 'MICRO', 'METER/METR', 'MAX', 'MATER/MATR/MATRI', 
    ...
    330 : {
        ...
        'QUIN/QUINT', 'QUART', 'QUAD/QUADR', 'PSEUD/PSEUDO', 'PROT/PROTO', 'PORT', 'POLY',
        'PHOT/PHOTO', 'PENT/PENTA', 'PATER/PATR/PATRI', 'PAN', 'OCT/OCTA/OCTO', 
        'NOV', 'NEG', 'MULTI', 'MILLI', 'MICRO', 'METER/METR', 'MAX', 'MATER/MATR/MATRI', 
        'MAR/MARI/MARIN', 'MAGN', 'MACRO', 'HYDR', 
        'HEX/HEXA', 'HEPT/HEPTA', 'GEO', 'GASTR', 'DU', 'DECI', 
        'CHRON', 'CEPHAL', 'BIO', 'BI/BIN', 'AVI', 'AUD/AUDI/AUDIO', 'AMBI/AMPHI'],
        question_types: {
    ...
    370 : {
        ...
        'QUIN/QUINT', 'QUART', 'QUAD/QUADR', 'PSEUD/PSEUDO', 'PROT/PROTO', 'PRE', 'PORT', 'POLY',
        'PHOT/PHOTO', 'PENT/PENTA', 'PATER/PATR/PATRI', 'PAN', 'PALE/PALEO', 'OCT/OCTA/OCTO', 
        'NOV', 'NEG', 'MULTI', 'MORPH', 'MILLI', 'MICRO', 'METER/METR', 'MAX', 'MATER/MATR/MATRI', 
        'MAR/MARI/MARIN', 'MAGN', 'MACRO', 'HYDR', 
        'HEX/HEXA', 'HEPT/HEPTA', 'GEO', 'GASTR', 'DU', 'DECI', 
        'CHRON', 'CEPHAL', 'BIO', 'BI/BIN', 'AVI', 'AUD/AUDI/AUDIO', 'AMBI/AMPHI'],
        question_types: {
    ...
    390 : {
        ...
        'MAR/MARI/MARIN', 'MAGN', 'MACRO', 'HYDR', 
        'HEX/HEXA', 'HEPT/HEPTA', 'GEO', 'GASTR', 'DU', 'DECI', 
        'CHRON', 'CEPHAL', 'BIO', 'BI/BIN', 'AVI', 'AUD/AUDI/AUDIO', 'ANIM', 'AMBI/AMPHI'],
        question_types: {
            'word_to_latin_root': .4,
            'word_to_english_root': .4,
            'word_to_translated_root': .4,
    ...
    400 : {
        ...
        'MAR/MARI/MARIN', 'MAGN', 'MACRO', 'HYDR', 
        'HEX/HEXA', 'HEPT/HEPTA', 'GEO', 'GASTR', 'DU', 'DECI', 
        'CHRON', 'CEPHAL', 'BIO', 'BI/BIN', 'AVI', 'AUD/AUDI/AUDIO', 'ASTRO/ASTER', 'AQU/AQUA', 'ANIM', 'AMBI/AMPHI'],
        question_types: {
            'word_to_latin_root': .4,
            'word_to_english_root': .4,
            'word_to_translated_root': .4,
